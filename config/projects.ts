...
export const projects: Project[] = [
  {
    ...
    description:
      'A Java application that allows you to find surebets in famous Greek bookmakers. Under development.',
  ...
  },
  {
    ...
    language: languages['javascript'],
    description:
      'Discord bot that keeps track of deleted and edited messages on my server.',
    links: {
  ...
  },
  {
    ...
    description:
      'Converts audio to downloadable files from several platforms like YouTube, MixCloud or SoundCloud. Made in Python Flask.',
    links: {
  ...
  },
  {
    ...
    description:
      'Covid-19 spread map with data from several sources, made when it first started.',
    links: {
