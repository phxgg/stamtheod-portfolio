          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center">
              <span
                ...
                className="float-left animate-wave text-2xl sm:text-3xl"
              >
                👋
              </span>
              &nbsp;
              ...
              >
                Hi<span className="text-pink-700 dark:text-pink-500">,</span> my
                name is
              </span>
            </div>
            ...
            >
              ...
              <br />I specialize in building (and occasionally designing)
